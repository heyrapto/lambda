                ...
                >
                  <div className="legal-page_heading-content">
                    <h1 className="legal-page_text heading-style-h2">
                      Lambda, Terms of Service (“Agreement”)
                    </h1>
                  ...
                  <div className="legal-page_content">
                    <div className="legal-rich-text w-richtext">
                      <p>
                        ...
                        (“Customer”), and Lambda Technologies, Inc.
                        (“Lambda”). It commences when you first sign up for
                      ...
                      <p>
                        2.1 Access. Lambda will provide you with secure
                      ...
                      <p>
                        2.4 Testing AI Products. You grant Lambda access to
                        your AI products for testing purposes. You retain
                        ownership of your AI products while permitting Lambda
                      ...
                      <ul role="list" className="list-disc">
                        ...
                        <li>
                          Lambda's liability shall not exceed the fees you
                      ...
                      <p>
                        Lambda is committed to protecting your data and
                      ...
                      <p>
                            Lambda may update these terms by notifying you.
